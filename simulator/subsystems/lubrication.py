...
class LubricationSystem:
    ...
    def step(
        ...
        # Heat generation from friction/combustion transferred into oil
        q_oil_gen = max(0.0, fuel_mass_flow_kg_s * self.tier_c.fuel_lhv_j_per_kg * self.tier_c.q_oil_fraction)
        ...
        oil_pressure_bar = max(0.5, min(self.tier_a.oil_press_max_bar, p_oil_raw))
